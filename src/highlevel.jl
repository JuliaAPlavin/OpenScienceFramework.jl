...
import Base.walkdir
Base.walkdir(proj::Project; kwargs...) = walkdir(directory(proj, ""); kwargs...)
function Base.walkdir(dir::Directory; topdown=true, onerror=throw)
    ...
    return Channel{Tuple{Directory,Vector{Directory},Vector{File}}}(chnl -> _walkdir(chnl, dir))
end
